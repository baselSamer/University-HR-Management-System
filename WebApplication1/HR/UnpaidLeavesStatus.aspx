<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnpaidLeavesStatus.aspx.cs" Inherits="WebApplication1.HR.UnpaidLeavesStatus" %>
...
<body>
    ...
    <form id="UnpaidLeavesStatus" runat="server">
        ...
        <h2>Unpaid Leave Requests</h2>

        <p>List of unpaid leaves pending HR approval:</p>

        <div class="grid-box">
            <asp:GridView ID="UnpaidLeavesTable"
                runat="server"
                AutoGenerateColumns="False"
                DataKeyNames="request_ID"
                OnRowCommand="UnpaidLeavesTable_RowCommand"
                GridLines="None"
                CellPadding="6"
                ForeColor="#222"
                BackColor="#f7faff">
